...
import { X, Link, Upload as UploadIcon, Trash2, Image, FileIcon, Eye, Download } from "lucide-react"
...
const Upload = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: files.length === 1 ? "File uploaded successfully" : "Files uploaded successfully",
        status: "success",
      })
      setFiles([])
      fetchUploadedFiles()
  ...
  const handleDeleteUploaded = (fileName) => {
    ...
    toast({
      title: "Information",
      description: `Delete functionality would remove "${fileName}"`,
      status: "info",
    })
  }
        ...
        {activeTab === "upload" ? (
          <>
            ...
            >
              ...
              <p className="text-gray-600 mt-2">
                <span className="underline text-purple-600 font-medium">Select files</span> or drag and drop here
              </p>
              <p className="text-gray-500 text-sm mt-1">Any file type, up to 10MB per file</p>
              <input
                type="file"
                multiple
                ref={inputRef}
              ...
              <>
                <div className="mt-8">
                  <div className="flex justify-between items-center mb-4">
                    <h2 className="text-lg font-medium">Files to Upload ({files.length})</h2>
                    <button
                      onClick={() => setFiles([])}
          ...
          <div>
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-bold text-gray-800">File Library</h2>
              <button
